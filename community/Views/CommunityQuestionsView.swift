...
final class CommunityQuestionsView: View {
    ...
    func configure(communityQuestions: Contentful.CommunityQuestions) {
        ...
        titleLabel.attributedText = communityQuestions.title.attributed.font(.crimsonText(.semiBold, size: 25)).color(.dark)
        subtitleLabel.attributedText = communityQuestions.info.attributed.font(.subHeader).color(.dark)
