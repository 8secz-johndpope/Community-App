...
open class MarqueeLabel: UILabel, CAAnimationDelegate {
    ...
    /**
     ...
     - SeeAlso: fadeLength
     */
    public init(frame: CGRect, rate: CGFloat, fadeLength: CGFloat, leadingBuffer: CGFloat = 0, trailingBuffer: CGFloat = 0) {
        self.speed = .rate(rate)
    ...
    /**
     ...
     - SeeAlso: fadeLength
     */
    public init(frame: CGRect, duration: CGFloat, fadeLength: CGFloat) {
